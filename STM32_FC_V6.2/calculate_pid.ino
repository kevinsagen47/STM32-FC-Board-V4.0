...
void calculate_pid(void) {
  ...
  if (pid_roll_setpoint_base > 1510)pid_roll_setpoint = pid_roll_setpoint_base - 1510;
  else if (pid_roll_setpoint_base < 1490)pid_roll_setpoint = pid_roll_setpoint_base - 1490;
  ...
  //We need a little dead band of 16us for better results.
  if (pid_pitch_setpoint_base > 1510)pid_pitch_setpoint = pid_pitch_setpoint_base - 1510;
  else if (pid_pitch_setpoint_base < 1490)pid_pitch_setpoint = pid_pitch_setpoint_base - 1490;
