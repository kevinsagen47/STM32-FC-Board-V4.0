...
//actual_pressure_slow = actual_pressure_slow * (float)0.985 + actual_pressure_fast * (float)0.015;
  ...
  if (channel_select_counter == 1){
   if(flight_mode==1){ 
    now1 = map(measured_time,1000,2000,1800,1200);
    channel_1=now1*(float)0.8+channel_1*(float)0.2;
   }
   else{
     now1 = map(measured_time,1000,2000,1750,1250);
    channel_1=now1*(float)0.8+channel_1*(float)0.2;
   }
  ...
  if (channel_select_counter == 2){
   if(flight_mode==1){ 
    now2 = map(measured_time,1000,2000,1800,1200);
    channel_2=now2*(float)0.8+channel_2*(float)0.2;
   }
   else{
     now2 = map(measured_time,1000,2000,1750,1250);
    channel_2=now2*(float)0.8+channel_2*(float)0.2;
   }
  ...
  if (channel_select_counter == 4)channel_4 = map(measured_time,1000,2000,1800,1200);
