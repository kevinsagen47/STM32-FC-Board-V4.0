...
#include <nRF24L01.h>
#include <RF24.h>
RF24 radio(PB13,PB12);   // nRF24L01 (CE, CSN)PB13,PB12 
...
float pid_d_gain_yaw = 0.007;                //Gain setting for the pitch D-controller (default = 0.0).
...
int32_t channel_6_start, channel_6,channel_7,channel_8;
